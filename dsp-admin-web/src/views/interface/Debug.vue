<template>
  <div>
    <el-card>
      ...
      <el-form :model="debugForm" label-width="100px">
        ...
        <el-form-item label="请求参数">
          <el-input v-model="debugForm.paramsJson" type="textarea" :rows="8"
            placeholder='请输入JSON格式参数，如：{"fundCode":"000001"}' style="font-family:monospace" />
        </el-form-item>
        <el-form-item>
      ...
      <el-input v-model="resultJson" type="textarea" :rows="15" readonly style="font-family:monospace"
        v-if="resultJson" />
